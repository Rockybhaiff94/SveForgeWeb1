...
export function TopBar({ user }: { user: any }) {
    ...
    const callbackUrl = encodeURIComponent(pathname === "/login" || pathname === "/signup" ? "/dashboard" : pathname);
                        ...
                        <div className="relative">
                            ...
                            {isProfileOpen && (
                                <div className="absolute right-0 mt-2 w-48 rounded-xl bg-[#121212] border border-white/10 shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 z-50">
                                    ...
                                    <div className="py-1">
                                        <Link href="/dashboard/profile" className="flex items-center gap-2 px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/5 transition-colors">
                                        ...
                                        <Link href="/dashboard/settings" className="flex items-center gap-2 px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/5 transition-colors">
